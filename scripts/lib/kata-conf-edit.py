...
def main():
    ...
    header = [
        ...
        '# global.  This file is selected by the ConfigPath RUNTIME OPTION that\n',
        '# Docker (daemon.json "options") and containerd CRI pass to the shim --\n',
        "# NOT by KATA_CONF_FILE, which Kata 4.1.0 accepts only for its own two\n",
        '# shipped default paths (containerd-shim-v2/create.go:325).\n',
        '#\n',
